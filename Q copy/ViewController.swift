...
class ViewController: UIViewController, SPTAudioStreamingPlaybackDelegate {
    ...
    let kClientID = "4c537cf2ccee4d7294a6c9ed06630c70"
    let kCallbackURL = "test://spotify/callback/"
    ...
    func playUsingSession(sessionObj:SPTSession!){
        ...
        player?.loginWithSession(sessionObj, callback: { (error : NSError!) -> Void in
            ...
            SPTRequest.requestItemAtURI(NSURL(string: "spotify:track:7caJcFZTtLzy0ZSol1AXKH"), withSession: sessionObj, callback: { (error : NSError!, trackObj:AnyObject!) -> Void in
                if error != nil {
